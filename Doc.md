...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/1Toxin/OrionFlame/main/source')))()
```
...
## Creating a Window
```lua
local Window = OrionLib:MakeWindow({Name = "Flame Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Flamehub"})
